...
class ProductComments extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->mypresta_link = 'https://ijzershop.nl';
    ...
    public function install($keep = true)
    {
        ...
        if (parent::install() == false ||
            ...
            !$this->registerHook('displayProductReviews') ||
    ...
    public function hookDisplayRating($params)
    {
    ...
    public function hookDisplayProductReviews($params)
    {
